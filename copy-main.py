...
class Results:
    def __init__(self, location):
        ...
        temporal_extent = ["2020-02-01", "2024-09-30"],
        bands=["B11", "B02", "B08"],
        max_cloud_cover = 50)
        ...
        job.start_and_wait()
        job.get_results().download_file("static/result.tiff")

        #swir1 = datacube.band("B11") * 0.00001
        #nir = datacube.band("B08") * 0.00001
        #blue = datacube.band("B02") * 0.00001

        #evi_cube = swir1 + nir + blue
